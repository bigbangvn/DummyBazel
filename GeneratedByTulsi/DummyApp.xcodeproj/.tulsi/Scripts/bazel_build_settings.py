...
BUILD_SETTINGS = BazelBuildSettings(
    ...
    set([
        '//DummyProjectUITests:DummyProjectUITests',
        '//DummyProjectTests:DummyProjectTestsLib',
        '//DummyProjectTests:DummyProjectTests',
        '//DummyProjectUITests:DummyProjectUITestsLib',
        '//Kumon:Kumon',
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/bang.nguyen/Library/Application Support/Tulsi/0.20200219.88/Bazel',

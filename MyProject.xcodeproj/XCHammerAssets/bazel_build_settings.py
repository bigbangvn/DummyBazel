...
BUILD_SETTINGS = BazelBuildSettings(
    ...
    BazelFlagsSet(),
    {
        '//DummyProject:AppMainLib': BazelFlagsSet(
            flags = BazelFlags(
                startup = [],
                build = [
                    '--build_event_publish_all_actions=true',
                    '--override_repository=tulsi=/usr/local/bin/xchammer.app/Contents/Resources',
                    '--override_repository=xchammer_resources=/usr/local/bin/xchammer.app/Contents/Resources',
                    '--aspects',
                    '@xchammer_resources//:xcode_configuration_provider.bzl%xcode_build_sources_aspect',
                    '--output_groups=+xcode_project_deps',
                ],
            ),
        ),
        '//DummyProject:DummyProject': BazelFlagsSet(
            flags = BazelFlags(
                startup = [],
                build = [
                    '--build_event_publish_all_actions=true',
